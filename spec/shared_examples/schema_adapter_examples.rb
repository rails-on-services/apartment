...
RSpec.shared_examples('a schema based adapter') do
  ...
  describe 'schema sequence operations' do
    before do
      Apartment.configure do |config|
  ...
  describe 'basic schema operations' do
    ...
    describe 'schema creation' do
      ...
      context 'when use_sql is true' do
        ...
        context 'when there are excluded names' do
          before do
            Apartment.configure do |config|
  ...
  describe 'default tenant behavior' do
    before do
      adapter.create(tenant_name)
  ...
  describe 'complex search paths' do
    include_context 'with adapter setup'
  ...
  describe 'pg_exclude_clone_tables' do
