...
RSpec.describe(Apartment::CLI::Migrations) do
  ...
  describe 'rollback' do
    ...
    context 'with ddl_role configured' do
      before do
        Apartment.configure do |c|
          c.tenant_strategy = :schema
          c.tenants_provider = -> { %w[acme beta] }
