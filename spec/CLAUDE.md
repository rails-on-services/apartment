...
> **Note**: This file primarily describes the v3 test suite. v4 unit tests live in `spec/unit/` (273 specs). v4 integration tests live in `spec/integration/v4/` (11 specs: tenant switching, lifecycle, excluded models). Run unit tests with `bundle exec rspec spec/unit/`. Run integration tests with `bundle exec appraisal rails-8.1-sqlite3 rspec spec/integration/v4/`. v3 specs in other directories remain for v3 code that hasn't been replaced yet.
